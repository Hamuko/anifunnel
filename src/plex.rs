...
impl Webhook {
    pub fn is_actionable(&self) -> WebhookState {
...
mod tests {
    ...
    fn webhook_actionable() {
        ...
        assert_eq!(webhook.is_actionable(), WebhookState::Actionable);
    }
    ...
    fn webhook_actionable_music() {
        ...
        assert_eq!(webhook.is_actionable(), WebhookState::IncorrectType);
    }
    ...
    fn webhook_actionable_missing_metadata() {
        ...
        assert_eq!(webhook.is_actionable(), WebhookState::NoMetadata);
    }
    ...
    fn webhook_actionable_playback() {
        ...
        assert_eq!(webhook.is_actionable(), WebhookState::NonScrobbleEvent);
    }

    #[test]
    // Second seasons are actionable.
    ...
    fn webhook_actionable_special() {
        ...
        assert_eq!(webhook.is_actionable(), WebhookState::IncorrectSeason);
    }
}
